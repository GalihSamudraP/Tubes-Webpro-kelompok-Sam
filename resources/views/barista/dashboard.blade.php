...
@section('content')
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-bold text-gray-900">Dashboard Barista</h1>
            <button onclick="window.location.reload();" class="text-sm text-amber-600 hover:text-amber-800">Refresh
                Pesanan</button>
        </div>
