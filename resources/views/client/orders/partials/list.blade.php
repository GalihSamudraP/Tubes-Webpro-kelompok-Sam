                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('orders.invoice', $order) }}"
                                class="ml-4 text-amber-600 hover:text-amber-800 text-sm font-medium underline">
                                Invoice
                            </a>
                        </div>

                        {{-- Payment Status Badge for Client --}}
                                    ...
                                    @foreach($order->items as $item)
                                        ...
                                        @if(!$existingRating)
                                            <form action="{{ route('rating.product') }}" method="POST"
                                                ...
                                                <select name="rating" class="mt-1 block w-full text-xs rounded-md border-gray-300" required>
